    ...
    if (user) {
        return (
            <Link href={'/mates/' + user.userName} className='c-c-c border p-1 rounded-2xl w-full'>
                <img src={user.pic ? user.pic : "https://i.pinimg.com/236x/c4/34/d8/c434d8c366517ca20425bdc9ad8a32de.jpg"} alt="" className="w-10 h-10 rounded-full object-cover-object-top" />
