...
const BtnAcceptMate = ({ userId, mate }) => {
  ...
  return (
    <>
      ...
      <button onClick={sendAcceptMate} className=' border w-[250px]  rounded-md border-green-700  opacity-80 hover:opacity-100  text-green-600 p-1 px-4 font-bold r-c-c'>
        {
          isLoading ?
            <Spinner />
            :
